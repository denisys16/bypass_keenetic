...
then
	...
	wget --no-check-certificate -O /opt/etc/ndm/fs.d/100-ipset.sh https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/100-ipset.sh
	...
	mkdir /opt/tmp/tor
	wget --no-check-certificate -O /opt/etc/tor/torrc https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/torrc
	#sed -i "s/hash:net/${set_type}/g" /opt/etc/tor/torrc
	echo "Установлены настройки Tor"
	
	wget --no-check-certificate -O /opt/etc/shadowsocks.json https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/shadowsocks.json
	...
	wget --no-check-certificate -O /opt/etc/unblocksh.txt https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/unblocksh.txt
	wget --no-check-certificate -O /opt/etc/unblocktor.txt https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/unblocktor.txt
	echo "Установлены сайты и ip адреса для обхода блокировок для обоих обходов"

	wget --no-check-certificate -O /opt/bin/unblock_ipset.sh https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/unblock_ipset.sh
	chmod +x /opt/bin/unblock_ipset.sh
	echo "Установлен скрипт для заполнения множеств unblock IP-адресами заданного списка доменов"
	
	
	wget --no-check-certificate -O /opt/bin/unblock_dnsmasq.sh https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/unblock_dnsmasq.sh
	...
	wget --no-check-certificate -O /opt/bin/unblock_update.sh https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/unblock_update.sh
	...
	wget --no-check-certificate -O /opt/etc/init.d/S99unblock https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/S99unblock
	...
	wget --no-check-certificate -O /opt/etc/ndm/netfilter.d/100-redirect.sh https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/100-redirect.sh
	...
	wget --no-check-certificate -O /opt/etc/dnsmasq.conf https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/dnsmasq.conf
	...
	wget --no-check-certificate -O /opt/etc/crontab https://raw.githubusercontent.com/denisys16/bypass_keenetic/master/crontab
